                                    ...
                                    <div class="single-popular-car">
                                        ...
                                        <div class="p-car-content">
                                            <h3>
                                                ...
                                                %>
                                                <h5 style="float:right;color:white;background: MediumSeaGreen;padding:5px 10px;">Booked <i class="fa fa-bookmark" aria-hidden="true"></i></h5>
                                                <%
                                                    } else {
                                                %>
                                                <form action="../deleteACarServlet" method="POST" >
                                                    ...
                                                    <input class="dnone" name="car_id" type="text" value="<%=resultSet.getString("c_id")%>">
                                                </form>
                                                <%
                                                    }
                                                %>

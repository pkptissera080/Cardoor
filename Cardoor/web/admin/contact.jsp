                ...
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="contact-form" >
                            ...
                            <!-- Section Title End -->
                            <!--== Car List Area Start ==-->
                            <div id="blog-page-content" class="section-padding" style='max-height: 700px;overflow: auto;'>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <%
                                            try {
                                                ...
                                                String sql = "SELECT * FROM messages ORDER BY m_datentime DESC";
                                                        ...
                                                        <div class="display-table">
                                                            <div class="display-table-cell">
                                                                <div class="article-body">
                                                                    <h3><a href="article-details.html"><%=resultSet.getString("m_subject")%></a></h3>
                                                                    <div class="article-meta">
                                                                        <a href="#" class="author">By :: <span><%=resultSet.getString("m_name")%></span></a><br>
                                                                        <a href="#" class="author">@<span><%=resultSet.getString("m_email")%></span></a>
                                                                    </div>

                                                                    <div  class="article-date"><%=resultSet.getString("m_datentime")%></div>

                                                                    <p><%=resultSet.getString("m_body")%></p>
                                                                    <div style="float: right;">
                                                                        <form action="../deleteAMessageServlet" method="POST" >
                                                                            <button class="btn cursorp" style="float:right;background-color: red; border: none;color: white;"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                                            <input class="dnone" name="m_id" type="text" value="<%=resultSet.getString("m_id")%>">
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg">
                                                        <div class="display-table">
                                                            <div class="display-table-cell">
                                                                <div class="article-body">
                                                                    <p><%=resultSet.getString("r_Message")%></p>
                                                                    <div class="article-meta">
                                                                        <a href="#" class="author">By :: <span><%=resultSet.getString("r_user")%></span></a><br>
                                                                    </div>

                                                                    <div><%=resultSet.getString("r_datentime")%></div>

                                                                    <div style="float: right;">
                                                                        <form action="../deleteAReviewServlet" method="POST" >
                                                                            <button class="btn cursorp" style="float:right;background-color: red; border: none;color: white;"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                                            <input class="dnone" name="r_id" type="text" value="<%=resultSet.getString("r_id")%>">
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>

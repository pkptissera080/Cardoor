                        ...
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="about-content">
                                    <p>We use all our experience – and the experiences of millions of our customers – to bring you the car you need and the quality of service you want. Always at the best price. But don’t take our word for it. Take a look at what real people think about Rentalcars.com.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="about-feature-item">
                                ...
                                <h3>Book</h3>
                                <p>You pick the car you want, add any extras you'd like - such as Full Protection (our extra cover) or a car seat - and book</p>
                            </div>
                        </div>
                        <!-- Single Fretutes End -->
                        ...
                        <div class="col-lg-3">
                            <div class="about-feature-item active">
                                ...
                                <p>You take the voucher (on paper or on your app), your credit card, driving licence and passport to pick up your car</p>
                            </div>
                        </div>
                        <!-- Single Fretutes End -->
                        ...
                        <div class="col-lg-3">
                            <div class="about-feature-item">
                                ...
                                <h3>Have a fantastic trip</h3>
                                <p>You drive away and start discovering...</p>
                            </div>
                        </div>
                        <!-- Single Fretutes End -->
                    </div>
